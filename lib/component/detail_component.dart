                ...
                child: Column(
                  children: [
                      ...
                      children: List.generate(
                        ...
                        (index) {
                          ...
                          return Container(
                            ...
                            child: Text(links!.homepage![index].validate(), style: secondaryTextStyle(), textAlign: TextAlign.right, overflow: TextOverflow.ellipsis),
                          ).onTap(() {
                      ...
                      children: List.generate(
                        ...
                        (index) {
                          ...
                          return Container(
                            width: context.width(),
                            padding: EdgeInsets.all(16),
                            child: Text(links!.blockchain_site![index].validate(), style: secondaryTextStyle(), textAlign: TextAlign.right),
                          ).onTap(() {
                      ...
                      children: List.generate(
                        ...
                        (index) {
                          ...
                          return Container(
                            ...
                            padding: EdgeInsets.all(16),
                            child: Text(
                              links!.official_forum_url![index].validate(),
                      ...
                      children: List.generate(
                        ...
                        (index) {
                          ...
                          return Container(
                            ...
                            padding: EdgeInsets.all(16),
                            child: Text(
                              links!.repos_url!.github![index].validate(),
                              style: secondaryTextStyle(),
                              textAlign: TextAlign.right,
                            ),
                          ).onTap(() {
                    ...
                    SettingItemWidget(
                      ...
                      onTap: () {
                        AppCommon.launchUrl("https://www.facebook.com/${links!.facebook_username.validate()}/");
                      },
                    ),
                    SettingItemWidget(
                      ...
                      trailing: Icon(Icons.arrow_forward_ios_sharp, size: 16),
                      onTap: () {
                        AppCommon.launchUrl("https://twitter.com/${links!.twitter_screen_name}/");
                      },
                    ),
                    SettingItemWidget(
