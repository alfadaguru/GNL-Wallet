...
import 'package:cryptocurrency_flutter/widgets/vimeo_embed_widget.dart';
import 'package:cryptocurrency_flutter/widgets/youtube_embed_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Html(
      ...
      onLinkTap: (s, _, __, ___) {
        AppCommon.launchUrl(s!, forceWebView: true);
      },
      style: {
