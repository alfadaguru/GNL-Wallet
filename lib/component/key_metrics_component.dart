...
class KeyMetricsComponent extends StatefulWidget {
  ...
  KeyMetricsComponent({required this.marketData});
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          MetricsWidget(
            divisibleBy: 1,
            value: '${getPercentageValueInCurrency(widget.marketData.ath_change_percentage!).validate().amountPrefix}',
            name: 'lbl_since_all_time_high'.translate,
          ),
          MetricsWidget(
            divisibleBy: 1,
            isCurrencyAllowed: false,
            value: '${getDates(widget.marketData.ath_date!).validate()}',
          ...
          MetricsWidget(
            divisibleBy: 1,
            value: '${getPercentageValueInCurrency(widget.marketData.atl_change_percentage!).validate().amountPrefix}',
            name: 'lbl_since_all_time_low'.translate,
          ),
          MetricsWidget(
            divisibleBy: 1,
            isCurrencyAllowed: false,
            value: '${getDates(widget.marketData.atl_date!).validate()}',
