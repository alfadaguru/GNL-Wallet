      ...
      child: Stack(
        children: [
          Container(
            ...
            width: context.width(),
            decoration: boxDecorationDefault(borderRadius: radius(20), gradient: LinearGradient(colors: [Colors.black.withOpacity(0.9), Colors.black.withOpacity(0.5)])),
            child: Column(
              ...
              children: [
                ...
                16.height,
                Text('${news.author}', style: primaryTextStyle(color: secondaryColor)),
              ],
            ),
          ),
        ],
